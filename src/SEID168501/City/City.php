...
class City extends Database
{
    ...
    public function index(){
        ...
        $query = "SELECT * FROM `tbl_cities` WHERE is_trashed = 'No'";
    ...
    public function trash(){
        $query = "UPDATE `tbl_cities` SET is_trashed = NOW() WHERE `id` = $this->id;";
    ...
    public function recover(){
        $query = "UPDATE `tbl_cities` SET is_trashed = 'No' WHERE `id` = $this->id;";
    ...
    public function delete(){
        $query = "DELETE FROM `tbl_cities` WHERE `id` = $this->id;";
    ...
    public function search($requestArray){
        $sql = "";
        if( isset($requestArray['byName']) && isset($requestArray['byCity']) )  $sql = "SELECT * FROM `tbl_cities` WHERE `is_trashed` ='No' AND (`name` LIKE '%".$requestArray['search']."%' OR `city` LIKE '%".$requestArray['search']."%')";
        if(isset($requestArray['byName']) && !isset($requestArray['byCity']) ) $sql = "SELECT * FROM `tbl_cities` WHERE `is_trashed` ='No' AND `name` LIKE '%".$requestArray['search']."%'";
        if(!isset($requestArray['byName']) && isset($requestArray['byCity']) )  $sql = "SELECT * FROM `tbl_cities` WHERE `is_trashed` ='No' AND `city` LIKE '%".$requestArray['search']."%'";
    ...
    public function indexPaginator($page=1,$itemsPerPage=3){
        ...
        $sql = "SELECT * from tbl_cities  WHERE is_trashed = 'No' LIMIT $start,$itemsPerPage";
    ...
    public function trashList(){
        ...
        $sql = "Select * from tbl_cities where is_trashed <> 'No'";
