...
class Hobbies extends Database
{
    ...
    public function index(){
        ...
        $query = "SELECT * FROM `tbl_hobbies` WHERE is_trashed = 'No'";
    ...
    public function trash(){
        $query = "UPDATE `tbl_hobbies` SET is_trashed = NOW() WHERE `id` = $this->id;";
    ...
    public function recover(){
        $query = "UPDATE `tbl_hobbies` SET is_trashed = 'No' WHERE `id` = $this->id;";
    ...
    public function delete(){
        $query = "DELETE FROM `tbl_hobbies` WHERE `id` = $this->id;";
    ...
    public function search($requestArray){
        $sql = "";
        if( isset($requestArray['byName']) && isset($requestArray['byHobbies']) )  $sql = "SELECT * FROM `tbl_hobbies` WHERE `is_trashed` ='No' AND (`name` LIKE '%".$requestArray['search']."%' OR `hobbies` LIKE '%".$requestArray['search']."%')";
        if(isset($requestArray['byName']) && !isset($requestArray['byHobbies']) ) $sql = "SELECT * FROM `tbl_hobbies` WHERE `is_trashed` ='No' AND `name` LIKE '%".$requestArray['search']."%'";
        if(!isset($requestArray['byName']) && isset($requestArray['byHobbies']) )  $sql = "SELECT * FROM `tbl_hobbies` WHERE `is_trashed` ='No' AND `hobbies` LIKE '%".$requestArray['search']."%'";
    ...
    public function indexPaginator($page=1,$itemsPerPage=3){
        ...
        $sql = "SELECT * from tbl_hobbies  WHERE is_trashed = 'No' LIMIT $start,$itemsPerPage";
    ...
    public function trashList(){
        ...
        $sql = "Select * from tbl_hobbies where is_trashed <> 'No'";
