    ...
    <div class="row">
        ...
        <div class="col-md-7">
            <div class="w3-bar w3-border w3-light-grey">
                ...
                <a href="index.php" class="w3-bar-item w3-button w3-black" style="text-decoration: none">Summary List</a>
                ...
                <div class="col-sm-6">
                    <div class="w3-panel">
                        <form id="searchForm" action="index.php"  method="get">
                            ...
                            <label> By Name</label>
                            <input class="w3-check" type="checkbox" name="bySummary" checked="checked">
                            <label> By Summary</label>
